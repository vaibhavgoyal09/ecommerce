              ...
              <div className="flex-col flex-1 flex justify-center gap-8">
                <div className="flex-col flex gap-8">
                  ...
                  <p className="max-[479px]:text-sm">
                    ...
                    aliqua. Proin fermentum leo vel orci. Dui faucibus in ornare
                    quam viverra orci sagittis eu. Viverra nam libero justo
                    laoreet sit amet. Vulputate odio ut enim blandit volutpat
                    maecenas volutpat blandit. A lacus vestibulum sed arcu non
                    odio euismod. Feugiat pretium nibh ipsum consequat. Cum
                    sociis natoque penatibus et. Leo in vitae turpis massa sed.
                    Neque aliquam vestibulum morbi blandit cursus. Facilisis sed
                    odio morbi quis. A pellentesque sit amet porttitor eget.
                  </p>
                </div>
                <div className="flex items-center justify-start gap-4 flex-wrap">
                  <a
                    href="#"
                    className="inline-block cursor-pointer items-center bg-black px-6 py-3 text-center font-semibold text-white"
                  >
                    Learn More
                  </a>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-4">
                  <div className="flex-col flex w-full items-start justify-between gap-4 border border-solid bg-[#f2f2f7] rounded-md p-6 md:p-4">
                    <div className="text-sm sm:text-sm">
                      ...
                      Their innovative solutions and expertise have transformed
